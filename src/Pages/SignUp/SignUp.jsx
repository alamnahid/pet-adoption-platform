  ...
  return (
    <div className="flex justify-evenly items-center mt-12 flex-col lg:flex-row">
      ...
      <div className="md:w-[28rem]">
        <h1 className="text-gray-700 text-center text-[2.5rem] font-semibold">Sign Up</h1>

        <form onSubmit={handleSubmit(onSubmit)}>

          <p className="text-[#444444ce] mt-5 text-xl font-semibold">Name</p>
          ...
          <p className="text-[#444444ce] mt-5 text-xl font-semibold">Photo</p>
          <div>
          ...
          <input className="w-full mt-5 h-[3.5rem] btn btn-neutral border-none bg-[#ADA7FF] text-white text-xl font-bold" type="submit" id="" value="Sign Up" />
          ...
          <p className="text-[#444444ce] mt-5 text-xl font-medium text-center">Or sign in with</p>
